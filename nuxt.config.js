export default {
  head: {
    ...
    meta: [
      ...
      { hid: 'twitter:title', name: 'twitter:title', content: 'Kenan DUFRENE - Portfolio' },
      ...
      { hid: 'twitter:image', name: 'twitter:image', content: '~/assets/uploads/og-image.png' },
      { hid: 'twitter:image:alt', name: 'twitter:image:alt', content: 'Kenan DUFRENE - Portfolio' },
      /// open-graph
      { hid: 'og:title', property: 'og:title', content: 'Kenan DUFRENE - Portfolio' },
      ...
      { hid: 'og:image', property: 'og:image', content: '~/assets/uploads/og-image.png' },
      { hid: 'og:image:secure_url', property: 'og:image:secure_url', content: '~/assets/uploads/og-image.png' },
      { hid: 'og:image:alt', property: 'og:image:alt', content: 'Kenan DUFRENE - Portfolio' }
    ],
    link: [
